...
### SCARA Robot Automation for Transformer Pin Dip-Tinning | GPV Lanka
...
![Layout_drawing](Assets/img/DOBOT/layout_drawing.png)
<sup>*Initial workstation layout concept designed in SolidWorks prior to physical implementation* </sup>
![Exploded_BOM_view](Assets/img/DOBOT/Enclosure.png)
<sup>*Production-deployed SCARA automation system integrated into electronics manufacturing line* </sup>
...
<!-- This is a comment in GitHub Markdown ![PCB_valve_control](Assets/img/PCB/Chlorine_valve_controller_front.png) -->
